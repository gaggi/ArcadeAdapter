 ...
 */
//#define  USB_CFG_DEVICE_ID       0x27db /* obdev's shared PID for USB Joysticks */
#define  USB_CFG_DEVICE_ID       0xdc, 0x27 /* obdev's shared PID for HIDs */
 ...
 */
#define USB_CFG_VENDOR_NAME     'g', 'a', 'G', 'G', 'i'
 ...
 * details.
 */
//#define USB_CFG_DEVICE_NAME     'A', 'r', 'c', 'a', 'd', 'e', ' ', 'A', 'd', 'a', 'p', 't', 'e', 'r'
//#define USB_CFG_DEVICE_NAME_LEN 14
/* Same as above for the device name. If you don't want a device name, undefine
 * the macros. See the file USBID-License.txt before you assign a name if you
 * use a shared VID/PID.
 */
//#define USB_CFG_SERIAL_NUMBER   'g', 's', 't', 'u', 'r', 'm', '1', '6', '@', 'g', 'm', 'a', 'i', 'l', '.', 'c', 'o', 'm', ':', 'a', 'r', 'c', 'a', 'd', 'e', '_', 'a', 'd', 'a', 'p', 't', 'e', 'r'
//#define USB_CFG_SERIAL_NUMBER   'g', 's', 't', 'u', 'r', 'm'
